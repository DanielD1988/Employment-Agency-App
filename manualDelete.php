<!-- 
	Daniel Dinelli
	C00242741
	A from to delete a course that has no students enrolled on it
-->
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<A HREF="mainMenu.html"><IMG SRC="logo.png"></a>
		...
		function populate(){//fills the input fields with data from a selected course
			...
			var personDetails = result.split(',');
				...
				document.getElementById("places").value = personDetails[5];
...
<section class="frame">
	<form action="deleteStatus.php" method="Post" onsubmit = "return confirmCheck()">
		<header class="title">
		...
		<div class = "left">	
			...
			<br>
			<div class="inputbox"><!-- For number of course places-->
				<label for="places">Number of places: </label>
				<input style="float:right;" type="number" name="places" min = "5" max = "30" id="places" title="Minimum 5 - Maximum 30" placeholder="5-30" disabled />
			</div>
			<br>
			...
			<div class="inputbox"><!-- Course Start Time-->
				...
				<input style="float:right;" type="time" name="STime" id="STime" disabled />
			</div>	
			<br>
			<div class="inputbox"><!-- Course End Time-->
				<label for="eTime">Course End Time: </label>
				<input style="float:right;" type="time" name="eTime" id="eTime" disabled />
			</div>	
		</div>
